  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="mt-1 text-sm text-gray-500">
                You can manage your department, faculty, and monitor student performance.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Role Information */}
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Your Role: Head of Department</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="border border-gray-200 rounded-lg p-4">
              <h4 className="font-medium text-gray-900 mb-2">Department Management</h4>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Faculty performance review</li>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Academic quality monitoring</li>
                <li>• Curriculum oversight</li>
                <li>• Accreditation support</li>
              </ul>
            </div>
            <div className="border border-gray-200 rounded-lg p-4">
              <h4 className="font-medium text-gray-900 mb-2">Administrative Tasks</h4>
              <ul className="text-sm text-gray-600 space-y-1">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
              ...
              <h4 className="font-medium text-gray-900">Faculty Management</h4>
              <p className="text-sm text-gray-500">Manage department faculty</p>
            </button>
            <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
            ...
            <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
              ...
              <p className="text-sm text-gray-500">Generate department reports</p>
            </button>
          </div>
        </div>
      </main>
